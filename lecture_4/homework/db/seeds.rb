...
available_mercenary = Mercenary.create!(name: 'Psriamus Brandagamba', experience: 5, preferred_weapon_kind: 'ranged', price: 20, available_from: 5.day.ago)
available_mercenary = Mercenary.create!(name: 'Priamsus Brandagamba', experience: 5, preferred_weapon_kind: 'ranged', price: 20, available_from: 5.day.ago)
available_mercenary = Mercenary.create!(name: 'Priamus Branadagamba', experience: 5, preferred_weapon_kind: 'ranged', price: 20, available_from: 5.day.ago)
available_mercenary = Mercenary.create!(name: 'Priamsazxus Brandagamba', experience: 5, preferred_weapon_kind: 'ranged', price: 20, available_from: 5.day.ago)
available_mercenary = Mercenary.create!(name: 'Priamus Brandasadgamba', experience: 5, preferred_weapon_kind: 'ranged', price: 20, available_from: 5.day.ago)
available_mercenary = Mercenary.create!(name: 'asd Brandagamba', experience: 5, preferred_weapon_kind: 'ranged', price: 20, available_from: 5.day.ago)
available_mercenary = Mercenary.create!(name: 'Priamus d', experience: 5, preferred_weapon_kind: 'ranged', price: 20, available_from: 5.day.ago)
available_mercenary = Mercenary.create!(name: 'Priaaaaamus Brandagamba', experience: 5, preferred_weapon_kind: 'ranged', price: 20, available_from: 5.day.ago)
