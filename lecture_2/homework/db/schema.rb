...
ActiveRecord::Schema.define(version: 2019_03_26_213801) do
  ...
  create_table "warriors", force: :cascade do |t|
    ...
    t.index ["weaponable_type", "weaponable_id"], name: "index_warriors_on_weaponable_type_and_weaponable_id"
  end
